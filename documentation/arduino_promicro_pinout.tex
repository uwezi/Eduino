...
\begin{document}
  \begin{tikzpicture}[x=1mm,y=1mm]
    % scale 2:1
    \path(0,.5) node[anchor=south,inner sep=0pt](im){\includegraphics[width=26.3mm]{arduino_pro_micro_blue}};
    \foreach[count=\cnt, evaluate=\cnt as \y using 46-\cnt*2.54*1.42] \i in {1,2,...,12}%
    {%
      \path(-13.5,\y) node[anchor=south east,inner sep=1mm,text width=3mm,align=right,scale=.4,blue](pin\i){ \i};
    }
    \foreach[count=\cnt, evaluate=\cnt as \y using -1+\cnt*2.54*1.42] \i in {13,14,...,24}%
    {%
      \path(+13.5,\y) node[anchor=south west,inner sep=1mm,text width=3mm,align=right,scale=.4,blue](pin\i){ \i};
    }

    \pighixxxpin[angle=180]{pin1.south east}{PD3/black/LightGoldenrod1/4mm,{1}/black/Magenta2/7mm,INT3/black/lightgray/8mm,TXD1/black/Aquamarine1/8mm}
    \pighixxxpin[angle=180]{pin2.south east}{PD2/black/LightGoldenrod1/4mm,{0}/black/Magenta2/7mm,INT2/black/lightgray/8mm,RXD1/black/Aquamarine1/8mm}
    \pighixxxpin[angle=180]{pin3.south east}{GND/white/black/7mm}
    \pighixxxpin[angle=180]{pin4.south east}{GND/white/black/7mm}
    \pighixxxpin[angle=180]{pin5.south east}{PD1/black/LightGoldenrod1/4mm,{2}/black/Magenta2/7mm,INT1/black/lightgray/8mm,SDA/black/SteelBlue1/5mm}
    \pighixxxpin[angle=180]{pin6.south east}{PD0/black/LightGoldenrod1/4mm,{3}/black/Magenta2/7mm,INT0/black/lightgray/8mm,SCL/black/SteelBlue1/5mm}
    \pighixxxpin[angle=180]{pin7.south east}{PD4/black/LightGoldenrod1/4mm,{4/A6}/black/Magenta2/7mm,ICP1/black/Thistle2/8mm,ADC8/black/SpringGreen3/8mm}
    \pighixxxpin[angle=180]{pin8.south east}{PC6/black/LightGoldenrod1/4mm,{5}/black/Magenta2/7mm,OC3A/black/IndianRed1/8mm,{/OC4A}/black/IndianRed1/8mm}
    \pighixxxpin[angle=180]{pin9.south east}{PD7/black/LightGoldenrod1/4mm,{6/A7}/black/Magenta2/7mm,T0/black/Thistle2/8mm,OC4D/black/IndianRed1/8mm,ADC10/black/SpringGreen3/8mm}
    \pighixxxpin[angle=180]{pin10.south east}{PE6/black/LightGoldenrod1/4mm,{7}/black/Magenta2/7mm,INT6/black/lightgray/10mm,AIN0/black/SpringGreen3/8mm}
    \pighixxxpin[angle=180]{pin11.south east}{PB4/black/LightGoldenrod1/4mm,{8/A8}/black/Magenta2/7mm,PCINT4/black/lightgray/10mm,ADC11/black/SpringGreen3/8mm}
    \pighixxxpin[angle=180]{pin12.south east}{PB5/black/LightGoldenrod1/4mm,{9/A9}/black/Magenta2/7mm,PCINT5/black/lightgray/10mm,ADC12/black/SpringGreen3/8mm,OC1A/black/IndianRed1/8mm,{/OC4B}/black/IndianRed1/8mm}

    \pighixxxpin[angle=0]{pin13.south west}{PB6/black/LightGoldenrod1/4mm,{10/A10}/black/Magenta2/7mm,PCINT6/black/lightgray/10mm,ADC13/black/SpringGreen3/8mm,OC1B/black/IndianRed1/8mm,OC4B/black/IndianRed1/8mm}
    \pighixxxpin[angle=0]{pin14.south west}{PB2/black/LightGoldenrod1/4mm,16/black/Magenta2/7mm,PCINT2/black/lightgray/10mm,MOSI/black/Turquoise1/8mm,PDI/black/Gold1/8mm}
    \pighixxxpin[angle=0]{pin15.south west}{PB3/black/LightGoldenrod1/4mm,{14}/black/Magenta2/7mm,PCINT3/black/lightgray/10mm,MISO/black/Turquoise1/8mm,PDO/black/Gold1/8mm}
    \pighixxxpin[angle=0]{pin16.south west}{PB1/black/LightGoldenrod1/4mm,15/black/Magenta2/7mm,PCINT1/black/lightgray/10mm,SCK/black/Turquoise1/8mm}
    \pighixxxpin[angle=0]{pin17.south west}{PF7/black/LightGoldenrod1/4mm,{18/A0}/black/Magenta2/7mm,ADC7/black/SpringGreen3/8mm,TDI/black/Gold1/5mm}
    \pighixxxpin[angle=0]{pin18.south west}{PF6/black/LightGoldenrod1/4mm,{19/A1}/black/Magenta2/7mm,ADC6/black/SpringGreen3/8mm,TDO/black/Gold1/5mm}
    \pighixxxpin[angle=0]{pin19.south west}{PF5/black/LightGoldenrod1/4mm,{20/A2}/black/Magenta2/7mm,ADC5/black/SpringGreen3/8mm,TMS/black/Gold1/5mm}
    \pighixxxpin[angle=0]{pin20.south west}{PF4/black/LightGoldenrod1/4mm,{21/A3}/black/Magenta2/7mm,ADC4/black/SpringGreen3/8mm,TCK/black/Gold1/5mm}
    \pighixxxpin[angle=0]{pin21.south west}{+3.3 V/black/Red1/7mm}
    \pighixxxpin[angle=0]{pin22.south west}{RESET/black/Gold1/8mm}
    \pighixxxpin[angle=0]{pin23.south west}{GND/white/black/7mm}
    \pighixxxpin[angle=0]{pin24.south west}{+5 V/black/Red1/7mm}

%    \pighixxxpin[angle=180]{pin9.south west}{PD6/black/LightGoldenrod1/4mm,{12/A11}/black/Magenta2/7mm,T1/black/Thistle2/8mm,{/OC4D}/black/IndianRed1/8mm,ADC9/black/SpringGreen3/8mm}
...
%
%    \pighixxxpin[angle=180]{pin2.south east}{PB0/black/LightGoldenrod1/4mm,{17}/black/Magenta2/7mm,PCINT0/black/lightgray/10mm,SS/black/Turquoise1/8mm}
%    \pighixxxpin[angle=180]{pin9.south east}{PB7/black/LightGoldenrod1/4mm,11/black/Magenta2/7mm,PCINT7/black/lightgray/10mm,OC0A/black/IndianRed1/8mm,OC1C/black/IndianRed1/8mm,RTS/black/Aquamarine1/8mm}
%
